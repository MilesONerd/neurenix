/**
 * MKL-DNN hardware backend header for Phynexus
 */

#ifndef PHYNEXUS_HARDWARE_MKLDNN_H
#define PHYNEXUS_HARDWARE_MKLDNN_H
...
/**
 * MKL-DNN hardware backend implementation
 */
class MKLDNNBackend : public Backend {
public:
    /**
...
private:
    ...
    /**
     * MKL-DNN allocation structure
     */
    struct MKLDNNAllocation {
        void* buffer;
        size_t size;
        size_t device_index;
    };
    ...
    std::unordered_map<void*, MKLDNNAllocation*> allocations_;
};

} // namespace hardware
} // namespace phynexus

#endif // PHYNEXUS_HARDWARE_MKLDNN_H
