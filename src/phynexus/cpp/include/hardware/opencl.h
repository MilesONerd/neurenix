/**
 * OpenCL hardware backend header for Phynexus
 */

#ifndef PHYNEXUS_HARDWARE_OPENCL_H
#define PHYNEXUS_HARDWARE_OPENCL_H
...
/**
 * OpenCL hardware backend implementation
 */
...
private:
    ...
    /**
     * OpenCL allocation structure
     */
    struct OpenCLAllocation {
        cl_mem buffer;
        size_t size;
        size_t device_index;
    };
    ...
    std::unordered_map<void*, OpenCLAllocation*> allocations_;
};

} // namespace hardware
} // namespace phynexus

#endif // PHYNEXUS_HARDWARE_OPENCL_H
